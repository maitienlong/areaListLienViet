...
public class ViewModelWard extends ViewModel {

    private Context context;
    private ArrayList<ListArea> areaArrayList;
    private AdapterRecycleViewTinh adapterRecycleViewTinh;
    private ActivityWardBinding binding;

    public ViewModelWard(Context context, ActivityWardBinding binding, String body) {
    ...
    private void ListView(ArrayList<ListArea> arrayList) {
        binding.listWard.setHasFixedSize(true);

        LinearLayoutManager linearLayout = new LinearLayoutManager(context);
        binding.listWard.setLayoutManager(linearLayout);
        adapterRecycleViewTinh = new AdapterRecycleViewTinh(context, arrayList);
        binding.listWard.setAdapter(adapterRecycleViewTinh);
        AdapterRecycleViewTinh.ItemClickSupport.addTo(binding.listWard).setOnItemClickListener(new AdapterRecycleViewTinh.ItemClickSupport.OnItemClickListener() {
            @Override
